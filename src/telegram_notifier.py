...
def send_telegram_report(
    position: str, company: str, job_url: str, to_email: str = "", source: str = ""
) -> bool:
    """
    Send one message to the configured Telegram chat: "Applied: [position] @ [company] – [job url]" plus email and source.
